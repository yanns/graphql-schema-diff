...
This crate was originally created in [grafbase/grafbase](https://github.com/grafbase/grafbase). When Grafbase was acquired, this crate became unmaintained. With the agreement of the original author, the code was forked into this standalone repository. (its git history was kept)
